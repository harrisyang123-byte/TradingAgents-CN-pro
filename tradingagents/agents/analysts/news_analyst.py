...
def create_news_analyst(llm):
    def news_analyst_node(state):
        ...
        system_message = (
            ...
            "Use the available tools: get_news(query, start_date, end_date) for "
            "company-specific or targeted news searches, and get_global_news(curr_date, "
            "look_back_days, limit) for broader macroeconomic news. Provide specific, "
