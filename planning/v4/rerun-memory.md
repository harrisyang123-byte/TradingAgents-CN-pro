...
## 2026-06-15 方法论纠错: Serenity"交易无人知晓的瓶颈"五因子模型
用户尖锐纠正"用研报找瓶颈方向错了": 研报=市场已知=高关注=价格已反映=没alpha。瓶颈靠缜密推理(专利/客户名单/产能地图/上游矿源)演绎,等市场后知后觉。
- 固化 planning/v4/unknown-bottleneck-framework.md (五因子: 需求确定+供给受限+低关注度+价值可捕获+催化剂; 紫苏叶理论)
- 重写 v4-alpha-hunter.md (五因子替换alpha三要素+禁研报); 更新 v4-industry-chokepoint.md; project-master §3 紫苏叶铁律
- 纠错: 不因当前利润未兑现就淘汰(提早介入是灵魂, 曾错杀盛科/长光华芯)
### 三主线紫苏叶挖掘(纯演绎不抓研报) → data/v4/_scan/zisu_bottleneck_alpha.json
verified市值后7只合格小市值紫苏叶:
- 标榜股份32亿(800V层叠母排) / 福立旺50亿(谐波柔轮特种钢带) / 晶升股份79亿(SiC长晶炉)
- 科德数控87亿(丝杠五轴磨床) / 德邦科技120亿(HBM塑封料) / 有研粉材138亿(纳晶软磁粉) / 安达智能141亿(光模块点胶设备)
...
## 2026-06-15(续2) 方法论再平衡: 低关注度从硬门槛→"未被充分定价"两条路径
用户纠正"低关注度门槛不用强行限制, 也会有被错杀的龙头(中际旭创我88买入), 目标是盈利, 产业链分析未被充分定价的都可纳入"。
### 方法论修正(4文档)
- framework/alpha-hunter/critic 6.14/project-master: ③"低关注度硬门槛"→"未被充分定价", 两条路径任一: (a)低关注度紫苏叶(信息不对称) 或 (b)被错杀卡位龙头(预期差, 卡位未变但价过度悲观)。不再因高关注度/大市值一刀切排除龙头。仍排除真高位泡沫。
### 被错杀龙头扫描 → data/v4/_scan/errokilled_leaders_2026-06-15.json
关键区分 错杀 vs 双杀:
- 错杀(纳入): 韦尔股份603501(CIS龙头,PE25.5,价格分位0.08极低,回撤75%,但ROE15.39+增速21.7%基本面健康=中际旭创88式) / 宁德时代300750(ROE24.91+增速42.3%+PE24.5 PEG<0.6估值低位) / 歌尔002241(增速47.9%但代工价值捕获弱,观察池)
- 双杀(排除价值陷阱): 卓胜微(亏损)/恩捷股份(锂膜利润崩)/奥特维(光伏下行)
- 高位(排除): 国瓷0.99/澜起0.98/立讯0.96/中微0.93
下一步: 韦尔/宁德进个股8-step做expert_valuation。

## 2026-06-15(续3) 完整8-step个股: 永太/韦尔/宁德
三只完整跑通(data-desk→4分析师→多空→3方风险→director→critic ACCEPT→落盘标准schema):
- 永太科技002326: 观察/留意池(困境反转博弈,现金流转负最硬红旗,买点¥17-18双确认开仓) critic87
- 韦尔股份603501: 建仓(健康错杀,CIS龙头净利恢复40.45亿+ROE15.4+负债35%, 但价格分位0.08被2021 PE89x泡沫夸大, 目标base¥101非bull¥145-179, 买点¥75-80) critic87
- 宁德时代300750: 建仓(优质龙头合理偏低, 护城河Very Wide9.0+ROE24%印钞机, 但PEG0.58是周期峰值幻觉修正~1.23, 目标base¥475买点¥360-380) critic87
三类标的诚实区分: 困境博弈(永太基本面未确认)vs健康错杀(韦尔基本面已恢复)vs优质龙头合理估值(宁德). 共性诚实纪律: 剔除bull乐观锚(永太六氟15万/韦尔泡沫PE55x/宁德PEG0.58), 用verified戳穿水分。

## 2026-06-15(续4) 12只热门行业批量分析+完整8-step扩展
完整8-step(critic ACCEPT 87-88真subagent):
- 东鹏饮料605499: 建仓★健康错杀典范(ROE51.6%A股前1%+净利3年47%CAGR无中断+PE15.5 PEG0.47分位0.03) critic88
- 安集科技688019 v2: 建仓优质卡位成长(CMP抛光液国产替代龙头, 真完整8-step驳回bear低基数数据错误) critic87
- 艾力斯688578: 买入低估高成长(伏美替尼BIC ROE35.4 PEG0.32) critic85
- 梅花生物600873: 建仓低估周期成长+高股息(PE7.6 ROE21.5, 诚实修正chokepoint过度乐观) critic86
其他热门主线深挖(主agent兜底): 立中/同花顺/金诚信/歌尔/华光/生益/中熔/维峰/铂科/悦安等

## 2026-06-15(续5) 港股扫描 + 行业供应链 + AI最底层产业链多轮深挖
- 港股: 快手01024建仓(健康错杀ROE26.3+净利186亿+分位0.13) / 比亚迪H 01211谨慎看多(EV龙头分位0.0历史最低但ROE15+净利326亿) / 美团03690排除(2025巨亏233亿外卖大战双杀)
- 行业供应链chokepoint: 消费电子+IoT/化工必需消费/有色金属资源 落verified, 最优=梅花生物(化工特种氨基酸卡位龙头,但verified后特种氨基酸仅3.1%营收非主驱动→修正为低估周期成长+高股息)
- AI产业链最底层物理瓶颈深挖(8主线): AI算力/半导体/机器人/CXO/有色/固态电池/商业航天/800V, 验证规律收敛=多数已炒高(分位0.9-1.0:福晶/三祥/华正/巨石/铖昌)或基本面双杀(南玻/华海诚科/中航光电)或左侧亏损(固态电池上游)。唯一未炒高+健康+卡位真=安集科技688019(CMP抛光液 ROE25 增速47%分位0.65)。

## 2026-06-15(续6) 前端展示层4处gap全修+回填推理链
1. 大类verdict扁平schema映射(7大类全恢复显示)
2. 投资方案plan扁平schema+PlanCard新展示段(6非权益大类含具体ETF代码)
3. critic_review→credibility兼容映射(本会话个股critic评分前端可见)
4. 选股池/产业链瓶颈Tab(AlphaScanTab.vue新建)+_scan透传(82文件)
5. 6只建仓股推理链回填(analysts/debate_rounds/risk_debate_summary/five_forces全字段)
6. plan ETF代码verified核对纠错(159861碳中和→512400有色南方/移除矛盾原油/贵金属公司名修正)
7. 老股fallback降级展示(_fallback_five_forces+_fallback_analysts标_data_status, 22只老股至少有最小展示)
